...
describe('CalendarWithPresets', () => {
  ...
  it(
    ...
    async () => {
      ...
      act(() => {
        render(<CalendarWithPresets onChange={onChange} />)
      })
  ...
  it('renders custom presets', () => {
    ...
    act(() => {
      render(<CalendarWithPresets presets={customPresets} />)
    })
  ...
  it(
    ...
    async () => {
      ...
      act(() => {
        render(
          <CalendarWithPresets value={{ from: new Date(2026, 2, 5), to: new Date(2026, 2, 8) }} onChange={onChange} />,
        )
      })
  ...
  it('hides calendar when showCalendar is false', () => {
    act(() => {
      render(<CalendarWithPresets showCalendar={false} />)
    })
  ...
  it('clamps preset range to min/max bounds', async () => {
    ...
    act(() => {
      render(<CalendarWithPresets onChange={onChange} minValue={minValue} />)
    })
  ...
  it('disables all interactions when isDisabled is true', () => {
    act(() => {
      render(<CalendarWithPresets isDisabled />)
    })
  ...
  it('renders two month panels in dual mode', () => {
    act(() => {
      render(<CalendarWithPresets visibleMonths={2} />)
    })
  ...
  it(
    ...
    async () => {
      const user = userEvent.setup()
      act(() => {
        render(<CalendarWithPresets value={{ from: new Date(2026, 2, 15) }} />)
      })
