...
import { DateNextCalendarNavButton } from './DateNextCalendarNavButton'

export interface DateNextCalendarHeaderProps {
...
export function DateNextCalendarHeader({
  title,
  color,
  radius,
  navButtonVariant,
