...
} from './AppointmentPickerNext.css'
...
export interface AppointmentValueNext {
  /** Selected date */
  date: Date
  /** Selected time slot */
  time: string
...
export const defaultTimeSlotsList: TimeSlotNext[] = [
...
export interface AppointmentPickerNextProps {
  /** Selected appointment value */
  value?: AppointmentValueNext
  /** Callback when appointment changes */
  onChange?: (value: AppointmentValueNext | undefined) => void
  /** Title displayed at the top */
  title?: string
  /** Available time slots for each day */
  getAvailableTimeSlots?: (date: Date) => TimeSlotNext[]
  /** Fallback slots used when getAvailableTimeSlots is not provided */
  defaultTimeSlots?: TimeSlotNext[]
  /** Meeting duration in minutes */
  meetingDurationMinutes?: number
  /** Callback when continue/confirm button is clicked */
  onConfirm?: (value: AppointmentValueNext) => void
  ...
  bookingMessage?: (value: AppointmentValueNext, durationMinutes: number) => string
...
export const AppointmentPickerNext = forwardRef<HTMLDivElement, AppointmentPickerNextProps>(
  (
    {
      value,
      onChange,
                ...
                {availableSlots.map(slot => {
                  ...
                  return (
                    <Button
                      ...
                      size={mapDateNextSizeToButtonSize(size)}
...
AppointmentPickerNext.displayName = 'AppointmentPickerNext'
