...
import { getDaysForMonth, normalizeDay, toDayKey } from './date-calendar-core'
import { useDateFormatters } from './useDateFormatters'

export interface UseDateCalendarOptions {
  ...
  /** Override computed day grid (e.g., 7 days for MiniCalendar week view). */
  days?: Date[]
...
export interface UseDateCalendarReturn {
...
}: UseDateCalendarOptions = {}): UseDateCalendarReturn {
