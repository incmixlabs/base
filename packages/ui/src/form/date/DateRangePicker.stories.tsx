...
import {
  dateColorValues,
  dateNavButtonVariantValues,
  dateRadiusValues,
  dateSizeValues,
  dateVariantValues,
  dateVisibleMonthControlLabels,
  dateVisibleMonthControlMapping,
  dateVisibleMonthControlOptions,
} from './date.props'
...
const meta: Meta<typeof DateRangePicker> = {
  ...
  argTypes: {
    ...
    visibleMonths: {
      control: { type: 'select' },
      options: dateVisibleMonthControlOptions,
      mapping: dateVisibleMonthControlMapping,
      labels: dateVisibleMonthControlLabels,
    },
  },
}
