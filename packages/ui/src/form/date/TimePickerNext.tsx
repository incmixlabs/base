...
export interface TimeValueNext {
  hours: number // 0-23
  minutes: number // 0-59
  seconds?: number // 0-59
}

export interface TimePickerNextProps {
  /** Selected time value (24-hour internal format) */
  value?: TimeValueNext
  /** Callback when time changes */
  onChange?: (time: TimeValueNext | undefined) => void
  /** Placeholder text */
  placeholder?: string
...
export function TimePickerNext({
  value,
  onChange,
  ...
  const snapshotRef = useRef<TimeValueNext | undefined>(undefined)
  ...
  const applyPicker = useCallback(() => {
    ...
    const tv: TimeValueNext = { hours, minutes: snapped }
