...
import { rangeTriggerGroupBase, rangeTriggerGroupSizeStyles } from './DateRangePickerNext.css'
...
describe('DateRangePickerNext', () => {
  it('does not render hidden inputs when name is not provided', () => {
    const { container } = render(<DateRangePickerNext ariaLabel="Travel dates" />)
  ...
  it('inherits size from FieldGroup when no explicit size is provided', () => {
    const { container } = render(
      <FieldGroup size="lg" variant="surface">
        <DateRangePickerNext ariaLabel="Travel dates" />
      </FieldGroup>,
    )
  ...
  it('keeps hidden inputs empty when range is undefined', () => {
    const { container } = render(<DateRangePickerNext ariaLabel="Travel dates" name="tripDate" />)
  ...
  it(
    ...
    async () => {
      ...
      render(<DateRangePickerNext ariaLabel="Travel dates" />)
  ...
  it('keeps controlled range stable on first click and updates after second click', async () => {
    ...
    function ControlledHarness() {
      ...
      return <DateRangePickerNext ariaLabel="Travel dates" name="tripDate" value={value} onChange={setValue} />
    }
  ...
  it('opens with Enter and closes with Escape in dual mode', async () => {
    const user = userEvent.setup()
    render(<DateRangePickerNext ariaLabel="Travel dates" visibleMonths={2} />)
