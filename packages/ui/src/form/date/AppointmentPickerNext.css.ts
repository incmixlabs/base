...
import {
  ...
  dateNextSecondaryFontSizeBySize,
  dateNextSecondaryLineHeightBySize,
  dateNextSizeValues,
  dateNextTitleFontSizeBySize,
  dateNextTitleLineHeightBySize,
} from './date-next.props'
import { getDateNextDisabledState } from './date-next-surface.shared'
...
const appointmentSlotWidthBySize: Record<DateNextSize, string> = {
  xs: '5.5rem',
  sm: '6rem',
  md: '7rem',
  lg: '8rem',
...
const appointmentSlotHeightBySize: Record<DateNextSize, string> = {
  xs: '180px',
  sm: '200px',
  md: '220px',
  lg: '240px',
...
export const appointmentPickerRootDisabled = style(getDateNextDisabledState())
  ...
  Object.fromEntries(
    sizeValues.map(size => {
      return [
        ...
        {
          vars: {
            [titleFontSizeVar]: dateNextTitleFontSizeBySize[size],
            [titleLineHeightVar]: dateNextTitleLineHeightBySize[size],
            [footerFontSizeVar]: dateNextSecondaryFontSizeBySize[size],
            [footerLineHeightVar]: dateNextSecondaryLineHeightBySize[size],
            [buttonGapVar]: dateNextControlGapBySize[size],
            [slotPaddingVar]: dateNextContainerPaddingBySize[size],
            [footerPaddingXVar]: dateNextControlPaddingXBySize[size],
            [footerPaddingYVar]: dateNextControlPaddingYBySize[size],
            [iconSizeVar]: dateNextControlIconSizeBySize[size],
