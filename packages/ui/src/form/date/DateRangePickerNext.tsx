...
import {
  ...
  dateNextRangeInputSurfaceClassName,
  getDateNextFieldSurfaceClassName,
  getDateNextSegmentClassName,
} from './date-next-field-shell'
import { dateNextCalendarNavButton, dateNextCalendarNavIcon } from './date-next-surface.shared.css'
...
export interface DateRangePickerNextProps {
...
export function DateRangePickerNext({
  value,
  defaultValue,
  onChange,
  minValue,
  ...
  const picker = (
    ...
    >
      ...
      >
        <div className={cn(floatingStyle ? dateNextRangeInputSurfaceClassName : rangeInputSurface)}>
        ...
        <AriaButton
          ...
          className={cn(
            floatingStyle ? [dateNextIconSlotClassName, dateNextGhostIconButtonClassName] : rangeCalendarButton,
