...
import { datePickerTriggerGroupRadiusStyles } from './DatePickerNext.css'

export const dateNextSegmentInputClassName = cn(
...
export const dateNextSegmentClassName = cn(
...
export function getDateNextSegmentClassName({
  type,
  isPlaceholder,
  isFocused,
  isFocusVisible,
...
export const dateNextIconSlotClassName = cn(
...
export function getDateNextFloatingLabelClassName(floatingStyle: FloatingStyle | null, isFloatingActive: boolean) {
  return cn(
...
export function DateNextFieldWrapper({
  label,
  disabled,
  floatingStyle,
  color,
  ...
  if (floatingStyle) {
    return (
      ...
      >
        ...
        {label ? (
          <label id={labelId} className={getDateNextFloatingLabelClassName(floatingStyle, true)}>
            {label}
          </label>
        ) : null}
      </div>
