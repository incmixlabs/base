...
const meta: Meta<typeof DatePickerNext> = {
  title: 'Form/Date Next/DatePickerNext (Spike)',
  ...
  render: args => {
    ...
    return (
      <div className="w-[320px] space-y-2">
        <DatePickerNext {...args} value={value} onChange={setValue} />
...
export const Playground: Story = {
  ...
  render: args => <DatePickerNext {...args} />,
}
...
export const WithBounds: Story = {
  render: args => {
    ...
    return (
      <div className="w-[320px] space-y-2">
        <DatePickerNext {...args} value={value} onChange={setValue} minValue={min} maxValue={max} />
...
export const WithDefaultValue: Story = {
  render: args => {
    return (
      <div className="w-[320px] space-y-2">
        <DatePickerNext {...args} defaultValue={new Date(2026, 0, 15)} />
...
export const WithCustomFormat: Story = {
  render: args => {
    ...
    return (
      <div className="w-[320px] space-y-2">
        <DatePickerNext {...args} value={value} onChange={setValue} dateFormat="dd/MM/yyyy" name="startDate" />
        <Text as="p" size="sm" className="text-muted-foreground">
...
export const WithDisabledDates: Story = {
  render: args => {
    ...
    return (
      <div className="w-[320px] space-y-2">
        <DatePickerNext {...args} value={value} onChange={setValue} disabledDates={disabledDates} />
        <Text as="p" size="sm" className="text-muted-foreground">
...
export const AllSizes: Story = {
  render: () => {
    const sizes = dateNextSizeValues
