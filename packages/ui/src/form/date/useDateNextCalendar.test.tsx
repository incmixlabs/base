...
import type { UseDateNextCalendarOptions } from './useDateNextCalendar'
...
function setup(options: UseDateNextCalendarOptions = {}) {
  let hookReturn!: ReturnType<typeof renderHook<ReturnType<typeof useDateNextCalendar>, UseDateNextCalendarOptions>>
  act(() => {
    hookReturn = renderHook(props => useDateNextCalendar(props), { initialProps: options })
  })
  return hookReturn
}

describe('useDateNextCalendar', () => {
  /* ── Display month ── */
