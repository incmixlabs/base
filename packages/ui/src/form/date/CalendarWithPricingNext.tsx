...
} from './CalendarWithPricingNext.css'
...
export interface CalendarWithPricingNextProps {
  /** Selected date */
  value?: Date
...
export const CalendarWithPricingNext = forwardRef<HTMLDivElement, CalendarWithPricingNextProps>(
  (
    {
      value,
      onChange,
    ...
    const priceMap = useMemo(() => {
      const map = new Map<string, DayPriceNext>()
...
CalendarWithPricingNext.displayName = 'CalendarWithPricingNext'
