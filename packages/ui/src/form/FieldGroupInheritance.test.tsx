...
import { checkboxSizeVariants } from './checkbox.class'
...
import { textFieldColorVariants, textFieldControlSizeVariants } from './text-field.class'
...
describe('FieldGroup inheritance', () => {
  it('uses resolved FieldGroup defaults for direct controls outside a provider', () => {
    ...
    expect(input).toHaveClass(textFieldControlSizeVariants.md)
  ...
  it('applies FieldGroup values to direct controls inside a provider', () => {
    ...
    const input = screen.getByRole('textbox', { name: 'Name' })
    expect(input).toHaveClass(textFieldControlSizeVariants.lg)
