...
export const mentionSuggestionBase =
  'fixed z-[9999] min-w-[200px] max-w-[300px] rounded-md border border-neutral bg-neutral-surface text-sm text-neutral shadow-lg animate-in fade-in-0 zoom-in-95'
...
export const mentionSuggestionEmpty = 'px-3 py-2 text-sm text-muted'
...
export const mentionDragOverlayText = 'text-sm'
...
export const mentionPreviewBase = 'min-h-20 rounded-md border border-neutral px-3 py-2 text-sm'
