...
export const checkboxGroupRootOrientation = {
  vertical: 'flex-col gap-[var(--component-checkbox-group-gap,0.5rem)]',
  horizontal: 'flex-row flex-wrap gap-[var(--component-checkbox-group-inline-gap,1rem)]',
} as const satisfies Record<CheckboxGroupOrientation, string>

export const checkboxGroupItemBase = 'flex items-start gap-[var(--component-checkbox-group-item-gap,0.5rem)]'
