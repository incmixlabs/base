...
const footerNavButtonClassName =
  'appearance-none border-0 bg-transparent p-0 font-[inherit] leading-[inherit] text-inherit hover:text-neutral'
...
const meta: Meta<typeof Section> = {
  ...
  tags: ['autodocs'],
  argTypes: {
    size: selectArgType(sectionPropDefs.size),
    display: selectArgType(sectionPropDefs.display),
  },
}
  ...
  render: () => (
    <Section className="bg-neutral-soft">
      <Container size="3">
        ...
        <p className="text-slate">This section uses size="3" which applies py-16 (64px vertical padding).</p>
      </Container>
    </Section>
  ),
}
  ...
  render: () => (
    <div>
      {sectionSizes.map((size, index) => (
        <Section key={size} size={size} className={index % 2 === 0 ? 'bg-light-surface' : 'bg-neutral-soft'}>
          <Container size="3">
...
export const LandingPage: Story = {
  render: () => (
    <div>
      {/* Hero Section */}
      <Section size="4" className="bg-primary-solid text-primary-contrast">
        <Container size="3" className="text-center">
          ...
          <div className="flex gap-4 justify-center">
            <Box p="3" px="6" color="light" variant="solid" radius="lg" className="font-medium">
              Get Started
            </Box>
            <Box p="3" px="6" radius="lg" className="border border-light font-medium text-primary-contrast">
              Learn More
            </Box>
          </div>
        </Container>
      ...
      {/* Features Section */}
      <Section size="3" className="bg-light-surface">
        <Container size="4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {['Fast', 'Flexible', 'Beautiful'].map(feature => (
              <Box key={feature} p="6" className="text-center">
                <div className="w-16 h-16 bg-primary-highlight rounded-full mx-auto mb-4 flex items-center justify-center">
                  <span className="text-primary text-2xl">✦</span>
                </div>
                <h3 className="font-semibold mb-2">{feature}</h3>
                <p className="text-sm text-slate">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
              </Box>
            ))}
          </div>
        </Container>
      ...
      <Section size="3" className="bg-neutral-soft">
        <Container size="3">
          <h2 className="text-2xl font-bold text-center mb-12">What People Say</h2>
          <Box p="8" color="light" variant="surface" radius="xl" className="text-center max-w-2xl mx-auto">
            <p className="text-lg italic mb-4">
              "This component library has transformed how we build products. The attention to detail is remarkable."
            </p>
            <div className="flex items-center justify-center gap-3">
              <div className="w-10 h-10 rounded-full bg-slate-soft" />
              <div className="text-left">
                <p className="font-medium">Jane Doe</p>
                <p className="text-sm text-slate">CEO, Example Inc</p>
              </div>
            </div>
          </Box>
        </Container>
      ...
      {/* CTA Section */}
      <Section size="2" className="bg-primary-solid text-primary-contrast">
        <Container size="2" className="text-center">
          ...
          <Box p="3" px="8" color="light" variant="solid" radius="lg" className="inline-block font-medium">
            Sign Up Free
          </Box>
        </Container>
      </Section>
      ...
      {/* Footer Section */}
      <Section size="1" className="border-t border-light bg-light-surface">
        <Container size="4">
          <div className="flex justify-between items-center">
            <p className="text-sm text-slate">© 2024 Company Name. All rights reserved.</p>
            <div className="flex gap-4 text-sm text-slate">
              <button type="button" className={footerNavButtonClassName}>
                Privacy
              </button>
              <button type="button" className={footerNavButtonClassName}>
                Terms
    ...
    <div>
      <Section size="3" className="bg-light-surface">
        <Container size="3">
          ...
          <p className="text-slate">Light background section for primary content areas.</p>
        </Container>
      </Section>
      ...
      <Section size="3" className="bg-neutral-soft">
        <Container size="3">
          ...
          <p className="text-slate">Slightly tinted background to create visual separation.</p>
        </Container>
      </Section>
      ...
      <Section size="3" className="bg-light-surface">
        <Container size="3">
          ...
          <p className="text-slate">Back to light background for variety.</p>
        </Container>
      </Section>

      <Section size="3" className="bg-primary-solid text-primary-contrast">
        <Container size="3">
...
export const ResponsiveSize: Story = {
  render: () => (
    <Section size={{ initial: '1', sm: '2', md: '3', lg: '4' }} className="bg-neutral-soft">
      <Container size="3">
        ...
        {Object.entries(previewWidths).map(([viewport, width]) => (
          <Tabs.Content key={viewport} value={viewport}>
            <div className="space-y-3 pt-4">
              ...
              <div className="border border-light rounded-xl overflow-hidden bg-light-surface" style={{ width }}>
                <Section size={{ initial: '1', md: '4' }} className="bg-neutral-soft">
                  <div className="px-4">
    ...
    <div>
      <Section size="3" className="bg-neutral-soft">
        <Container size="3">
          ...
          <p className="text-sm text-slate">Uses the preset vertical padding.</p>
        </Container>
      </Section>

      <Section py="9" className="bg-light-surface">
        <Container size="3">
      ...
      <Section pt="2" pb="8" className="bg-neutral-soft">
        <Container size="3">
          <h3 className="font-semibold mb-2">Asymmetric padding pt="2" pb="8"</h3>
          <p className="text-sm text-slate">Different top and bottom padding for special layouts.</p>
        </Container>
      </Section>
    </div>
  ),
