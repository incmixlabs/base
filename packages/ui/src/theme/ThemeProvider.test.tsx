...
describe('ThemeProvider', () => {
  ...
  it('exposes app shell surface defaults and content body vars', () => {
    ...
    expect(root?.style.getPropertyValue('--af-content-body-background')).toBe('var(--color-info-surface)')
    expect(root?.style.getPropertyValue('--af-content-body-foreground')).toBe('var(--color-info-text)')
    expect(root?.style.getPropertyValue('--af-content-body-border-color')).toBe('var(--color-info-border)')
