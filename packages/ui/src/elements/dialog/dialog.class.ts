...
export const dialogBackdropBaseCls =
  'fixed inset-0 z-50 duration-200 ease-in-out data-[starting-style]:animate-in data-[starting-style]:fade-in-0 data-[ending-style]:animate-out data-[ending-style]:fade-out-0'

export const dialogBackdropBase = '[background-color:rgb(0_0_0_/_0.24)] backdrop-blur-[4px]'

export const dialogPopupBaseCls =
  'fixed z-50 box-border rounded-[var(--element-border-radius)] border border-solid border-neutral bg-neutral-surface text-neutral shadow-[var(--shadow-4)] duration-200 ease-in-out focus:outline-none data-[starting-style]:animate-in data-[starting-style]:fade-in-0 data-[starting-style]:zoom-in-95 data-[ending-style]:animate-out data-[ending-style]:fade-out-0 data-[ending-style]:zoom-out-95'
