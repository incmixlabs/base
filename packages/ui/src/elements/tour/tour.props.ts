...
export const tourPropDefs = {
  ...
  nextLabel: { type: 'ReactNode', default: 'Next' },
  finishLabel: { type: 'ReactNode', default: 'Finish' },
  prevLabel: { type: 'ReactNode', default: 'Previous' },
  skipLabel: { type: 'ReactNode', default: 'Skip' },
  ...
  skipButtonProps: { type: 'object', typeFullName: 'ButtonProps' },
  closeButtonProps: { type: 'object', typeFullName: 'TourCloseProps' },
