 ...
 *
 * CSS `fill` cascades from the floating content surface through the arrow wrapper into the SVG.
 *
...
export function FloatingArrowSvg(props: React.ComponentProps<'svg'>) {
  return (
    <svg width="20" height="10" viewBox="0 0 20 10" {...props}>
      {/* Arrow fill - inherits CSS fill from the floating content surface. */}
      ...
      {/* Edge and inner fill - inherit the same content surface fill. */}
