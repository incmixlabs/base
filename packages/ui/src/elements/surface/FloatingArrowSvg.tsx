 ...
 *
 * CSS `fill` and `color` cascade from the arrow wrapper into the SVG.
 *
...
export function FloatingArrowSvg(props: React.ComponentProps<'svg'>) {
  return (
    <svg width="20" height="10" viewBox="0 0 20 10" {...props}>
      {/* Arrow fill - inherits CSS fill from the arrow wrapper. */}
      ...
      {/* Edge - inherits CSS color from the arrow wrapper. */}
      <path
        d="M8.99542 1.85876C9.75604 1.17425 10.9106 1.17422 11.6713 1.85878L16.5281 6.22989C17.0789 6.72568 17.7938 7.00001 18.5349 7.00001L15.89 7L11.0023 2.60207C10.622 2.2598 10.0447 2.2598 9.66436 2.60207L4.77734 7L2.13171 7.00001C2.87284 7.00001 3.58774 6.72568 4.13861 6.22989L8.99542 1.85876Z"
        fill="currentColor"
      />
      {/* Inner fill - inherits CSS fill from the arrow wrapper. */}
