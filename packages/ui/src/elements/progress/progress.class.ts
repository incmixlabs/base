...
export const progressIndicatorBase =
  'relative h-full [transition:var(--af-progress-motion-indicator-transition,width_150ms_var(--af-ease-standard),background-color_var(--af-motion-fast)_var(--af-ease-standard),filter_var(--af-motion-fast)_var(--af-ease-standard))]'

export const progressSizeVariants = {
  xs: 'h-[var(--af-progress-size-xs-height,0.25rem)]',
  sm: 'h-[var(--af-progress-size-sm-height,0.375rem)]',
  md: 'h-[var(--af-progress-size-md-height,0.5rem)]',
  lg: 'h-[var(--af-progress-size-lg-height,0.75rem)]',
} as const
...
export const progressTrackVariantStyles = {
  ...
  classic:
    'bg-neutral-soft border border-solid border-neutral [box-shadow:var(--af-progress-variant-classic-box-shadow,var(--shadow-xs))]',
...
export const progressIndicatorIndeterminate =
  'w-[var(--af-progress-motion-indeterminate-width,40%)] animate-[progress-indeterminate_var(--progress-indeterminate-duration,1s)_var(--af-ease-standard)_infinite]'
