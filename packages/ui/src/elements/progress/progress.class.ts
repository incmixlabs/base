...
export const progressIndicatorBase =
  'relative h-full [transition:width_150ms_var(--af-ease-standard),background-color_var(--af-motion-fast)_var(--af-ease-standard),filter_var(--af-motion-fast)_var(--af-ease-standard)]'
