...
function createValidThemeContract() {
  return {
    ...
    component: {
      appShell: { content: { paddingInline: '1rem' } },
    },
  }
}
...
describe('theme contract validation', () => {
  ...
  it('rejects non-string component token leaves', () => {
    ...
    theme.component.appShell.content.paddingInline = 12 as never
  ...
  it('rejects unknown component token branches and unsupported slots', () => {
    ...
    ;(theme.component.appShell.content as Record<string, unknown>).previewMinHeight = '96px'
